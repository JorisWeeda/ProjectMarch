...
# Install build tools
RUN apt update && apt upgrade -y && apt install python-rosdep python-rosinstall python-rosinstall-generator build-essential python3-colcon-common-extensions python3-pip python-pip python-catkin-pkg python-catkin-lint clang-tidy clang gcovr -y
